...
- [Station 1: prepare the data](station-01-notes.md)
- [Station 2: show the results](station-02-notes.md)
...
- [Analysis table](reference-analysis.csv) and [handover note](reference-handover.md)
- [Results figure](reference-figure.png) and [results note](reference-results.md)
